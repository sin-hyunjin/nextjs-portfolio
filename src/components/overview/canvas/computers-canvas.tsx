  ...
  return (
    <mesh>
      ...
      <primitive
        ...
        scale={isVerySmall ? 0.35 : isMobile ? 0.47 : 0.6} // 매우 작은 화면일 때 적용
        position={
          isVerySmall ? [0, -3, -1] : isMobile ? [0, -3, -0.6] : [0, -2.4, -1.5]
        }
        rotation={[-0.0, -0.3, -0.13]}
      />
    </mesh>
  );
};
...
const ComputersCanvas = () => {
  ...
  useEffect(() => {
    ...
    const mediaQueryVerySmall = window.matchMedia("(max-width: 400px)");
